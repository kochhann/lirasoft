...
urlpatterns = [
    ...
    path('gerar_nota_contrato/<int:gContrato>/<slug:gEmpresa>/', geraNotaContrato, name='create_nota_contrato'),
    path('gavar_nota_contrato/<int:gContrato>/<slug:gEmpresa>/', gravaNotaContrato, name='grava_nota_contrato'),
